...
function train(name, loadname, xtrn, ytrn, dtst, epochs; weight_decay = 1e-6,optimizer = Nesterov, momentum = 0.95, lr = 0.1)
...
endswith(string(PROGRAM_FILE), "SelfAttnNet_w_DataAugment.jl") && train("f_SelfAttnNet_334_moment", "", xtrn, ytrn, dtst, 250; lr = 0.1)
