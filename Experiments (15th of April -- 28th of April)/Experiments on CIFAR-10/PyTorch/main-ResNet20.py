...
from models.backbone.ResNet20 import ResNet
...
if args.resume:
    ...
    checkpoint = torch.load('./checkpoint/resnet20_v1.pth')
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint/resnet20_v1.pth')
        best_acc = acc
